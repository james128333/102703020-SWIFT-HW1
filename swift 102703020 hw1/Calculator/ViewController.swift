...
class ViewController: UIViewController {
    ...
    @IBAction func multixbutton(sender: UIButton) {
...
//    @IBAction func floating(sender: UIButton) {
  ...
  //  }
    ...
    @IBAction func percantage(sender: UIButton) {
       // try! self.core.addStep(self.displayLabel.floatValue)
      //  try! self.core.addStep(+)
     //   self.core.addStep(*)
    // self.displayLabel.floatValue = self.displayLabel.floatValue / 100
      self.displayLabel.percen()
    }
    ...
    @IBAction func adddig(sender: UIButton) {
        self.displayLabel.adddigit()
        }
